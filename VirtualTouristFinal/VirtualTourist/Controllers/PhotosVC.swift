...
class PhotosVC : UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, NSFetchedResultsControllerDelegate, MKMapViewDelegate {
    ...
    @IBAction func buttomButtonTapped(_ sender: Any) {
        ...
        API.getPhotos(with: pin.cord, pageNum: pageNumber) { (urls, error, errorMessage) in
